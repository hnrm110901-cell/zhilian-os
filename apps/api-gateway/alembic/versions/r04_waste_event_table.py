...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('event_type', postgresql.ENUM(name='wasteeventtype', create_type=False), nullable=False, server_default='unknown'),
        sa.Column('status', postgresql.ENUM(name='wasteeventstatus', create_type=False), nullable=False, server_default='pending'),
