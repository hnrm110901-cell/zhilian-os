...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('category', postgresql.ENUM(name='rulecategory', create_type=False), nullable=False),
        sa.Column('rule_type', postgresql.ENUM(name='ruletype', create_type=False), nullable=False, server_default='threshold'),
        ...
        sa.Column('status', postgresql.ENUM(name='rulestatus', create_type=False), nullable=False, server_default='draft'),
    ...
    op.create_table(
        ...
        sa.Column('metric_category', postgresql.ENUM(name='rulecategory', create_type=False), nullable=False),
