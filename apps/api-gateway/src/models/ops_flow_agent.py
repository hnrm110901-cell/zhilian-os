...
from sqlalchemy import Boolean, Column, DateTime, Float, Index, Integer, Numeric, String, Text, func
...
OpsChainEventTypeEnum = ENUM(
    ...
    "inventory_expiry",
    "quality_pattern",
    name="ops_chain_event_type_enum",
    create_type=True,
)
...
OpsChainEventSeverityEnum = ENUM(
    ...
    "warning",
    "critical",
    name="ops_chain_event_severity_enum",
    create_type=True,
)
...
OpsOrderAnomalyTypeEnum = ENUM(
    ...
    "cancel_surge",
    "avg_order_drop",
    name="ops_order_anomaly_type_enum",
    create_type=True,
)
...
OpsInventoryAlertTypeEnum = ENUM(
    ...
    "overstock",
    "restock_overdue",
    name="ops_inventory_alert_type_enum",
    create_type=True,
)
...
class OpsChainLinkage(Base):
    ...
    __table_args__ = (Index("idx_ops_linkage_event", "trigger_event_id"),)
...
class OpsOrderAnomaly(Base):
    ...
    __table_args__ = (Index("idx_ops_order_anomaly_store", "store_id", "created_at"),)
...
class OpsFlowDecision(Base):
    ...
    __table_args__ = (Index("idx_ops_decision_store_priority", "store_id", "priority"),)
...
class OpsFlowAgentLog(Base):
    ...
    __table_args__ = (Index("idx_ops_log_agent_type", "agent_type", "created_at"),)
