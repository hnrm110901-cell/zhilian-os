...
class FCTBankAccount(Base, TimestampMixin):
    ...
    __table_args__ = (UniqueConstraint("entity_id", "account_no", name="uq_bank_entity_account"),)
...
class FCTBankTransaction(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_bank_tx_date", "bank_account_id", "tx_date"),)
...
class FCTTaxDeclaration(Base, TimestampMixin):
    ...
    __table_args__ = (UniqueConstraint("entity_id", "period", "declaration_type", name="uq_tax_decl_entity_period_type"),)
