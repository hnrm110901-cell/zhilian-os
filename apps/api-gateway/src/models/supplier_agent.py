...
class SupplierProfile(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_supplier_profiles_brand_tier", "brand_id", "tier"),)
...
class MaterialCatalog(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_material_catalogs_brand_code", "brand_id", "material_code"),)
...
class SupplierDelivery(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_supplier_deliveries_supplier_date", "supplier_id", "promised_date"),)
...
class PriceComparison(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_price_comparisons_brand_material", "brand_id", "material_id"),)
...
class SupplierEvaluation(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_supplier_evaluations_supplier_period", "supplier_id", "eval_period"),)
...
class SourcingRecommendation(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_sourcing_recommendations_brand", "brand_id", "trigger"),)
...
class ContractAlert(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_contract_alerts_brand_resolved", "brand_id", "is_resolved"),)
...
class SupplyRiskEvent(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_supply_risk_events_brand_level", "brand_id", "risk_level"),)
...
class SupplierAgentLog(Base, TimestampMixin):
    ...
    __table_args__ = (Index("ix_supplier_agent_logs_brand_type", "brand_id", "agent_type"),)
