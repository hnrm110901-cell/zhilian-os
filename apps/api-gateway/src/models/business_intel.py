...
BizIntelAgentTypeEnum = PgEnum(
    ...
    "biz_insight",
    "scenario_match",
    name="biz_intel_agent_type_enum",
    create_type=True,
)
...
class BizMetricSnapshot(Base):
    ...
    __table_args__ = (Index("idx_biz_snapshot_brand_store_date", "brand_id", "store_id", "snapshot_date"),)
...
class RevenueAlert(Base):
    ...
    __table_args__ = (Index("idx_revenue_alert_brand_store_date", "brand_id", "store_id", "alert_date"),)
...
class KpiScorecard(Base):
    ...
    __table_args__ = (Index("idx_kpi_scorecard_brand_store_period", "brand_id", "store_id", "period"),)
...
class OrderForecast(Base):
    ...
    __table_args__ = (Index("idx_order_forecast_brand_store_date", "brand_id", "store_id", "forecast_date"),)
...
class BizDecision(Base):
    ...
    recommendations = Column(
        JSON, nullable=False
    )  # [{rank, title, action, expected_saving_yuan, confidence, urgency_hours, category}]
    ...
    __table_args__ = (Index("idx_biz_decision_brand_store_date", "brand_id", "store_id", "decision_date"),)
...
class ScenarioRecord(Base):
    ...
    __table_args__ = (Index("idx_scenario_brand_store_date", "brand_id", "store_id", "record_date"),)
