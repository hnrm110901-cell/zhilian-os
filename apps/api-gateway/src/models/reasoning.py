...
from sqlalchemy import Boolean, Column, Date, DateTime, Float, Index, String, UniqueConstraint
...
class ReasoningReport(Base, TimestampMixin):
    ...
    def __repr__(self) -> str:
        return f"<ReasoningReport(" f"{self.store_id}/{self.dimension}/{self.report_date}: {self.severity}" f")>"
