...
from sqlalchemy import Boolean, Column, Date, DateTime, Float, Index, Integer, Numeric, String, Text, func
...
PerformanceRatingEnum = ENUM(
    ...
    "below",
    "unsatisfactory",
    name="people_performance_rating_enum",
    create_type=True,
)
...
AttendanceAlertTypeEnum = ENUM(
    ...
    "overtime",
    "understaffed",
    name="people_attendance_alert_type_enum",
    create_type=True,
)
...
StaffingDecisionStatusEnum = ENUM(
    ...
    "accepted",
    "rejected",
    name="people_staffing_decision_status_enum",
    create_type=True,
)
...
class PeopleShiftRecord(Base):
    ...
    __table_args__ = (Index("idx_people_shift_brand_store_date", "brand_id", "store_id", "shift_date"),)
...
class PeoplePerformanceScore(Base):
    ...
    __table_args__ = (Index("idx_people_perf_brand_store_emp_period", "brand_id", "store_id", "employee_id", "period"),)
...
class PeopleLaborCostRecord(Base):
    ...
    __table_args__ = (Index("idx_people_labor_brand_store_period", "brand_id", "store_id", "period"),)
...
class PeopleAttendanceAlert(Base):
    ...
    __table_args__ = (Index("idx_people_alert_brand_store_date", "brand_id", "store_id", "alert_date"),)
...
class PeopleStaffingDecision(Base):
    ...
    __table_args__ = (Index("idx_people_staffing_brand_store_date", "brand_id", "store_id", "decision_date"),)
...
class PeopleAgentLog(Base):
    ...
    __table_args__ = (Index("idx_people_log_brand_created", "brand_id", "created_at"),)
