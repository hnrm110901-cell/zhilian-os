...
class PDFReportService:
    ...
    def generate_income_statement_pdf(self, data: Dict[str, Any], start_date: datetime, end_date: datetime) -> bytes:
        """
        生成损益表PDF
        ...
        date_range = Paragraph(
            f"Period: {start_date.strftime('%Y-%m-%d')} to {end_date.strftime('%Y-%m-%d')}", self.normal_style
        )
    ...
    def generate_cash_flow_pdf(self, data: Dict[str, Any], start_date: datetime, end_date: datetime) -> bytes:
        """
        生成现金流量表PDF
