...
RESOURCE_GROUPS: Dict[str, List[str]] = {
    "Agent调度": [
        Permission.AGENT_SCHEDULE_READ, Permission.AGENT_SCHEDULE_WRITE,
    ],
    "Agent订单": [
        Permission.AGENT_ORDER_READ, Permission.AGENT_ORDER_WRITE,
    ],
    "Agent库存": [
        Permission.AGENT_INVENTORY_READ, Permission.AGENT_INVENTORY_WRITE,
    ],
    "Agent决策": [
        Permission.AGENT_DECISION_READ, Permission.AGENT_DECISION_WRITE,
    ],
    "Agent绩效": [
        Permission.AGENT_PERFORMANCE_READ, Permission.AGENT_PERFORMANCE_WRITE,
    ],
    "用户管理": [
    ...
    "语音设备": [
        Permission.VOICE_DEVICE_READ, Permission.VOICE_DEVICE_WRITE,
