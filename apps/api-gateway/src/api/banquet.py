...
async def today_banquet_check(
    ...
    try:
        ...
        banquets = [r for r in reservations if r.get("reservation_type") == ReservationType.BANQUET.value]
    ...
    circuit_results = []
    for b in banquets:
        cb = banquet_planning_engine.check_circuit_breaker(banquet=b, store_id=store_id, plan_date=td)
