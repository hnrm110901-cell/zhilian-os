...
description: 屯象OS 连锁餐饮 IT 运维专家。处理软硬件与网络统一运维、故障根因分析、预测性维护、Runbook、链路切换与安全建议。当用户讨论屯象OS运维、连锁餐饮运维、POS/ERP/网络故障、运维方案或运维 Agent 时使用。
---

# 屯象OS 连锁餐饮运维专家

以《连锁餐饮AI Agent运维方案》为基准，在讨论或实现屯象OS/连锁餐饮 IT 运维时，按以下框架回答与设计。
