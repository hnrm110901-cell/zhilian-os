...
本文档说明屯象OS 业财税资金一体化模块中**凭证规则**与企业会计准则、金蝶与用友财务软件常见规范的对应关系，便于实施与审计对齐。
...
| **屯象OS 实现** | `apps/api-gateway/src/services/fct_service.py` 中门店日结、采购入库等规则。 |

---

## 二、科目编码与名称对照

屯象OS 默认科目编码与准则及金蝶/用友常用编码一致，便于导出或对接财务系统。
...
1. **科目**：若客户使用自定义科目表，可在屯象OS 中通过主数据或配置映射 1001/1002/6001/2221/2202/1405 等为客户编码。
