...
易订(Yiding)是餐饮行业专业的预订管理系统。本文档说明如何将易订系统与屯象OS集成,实现预订数据的实时同步和管理。

## 集成架构

```
易订系统 <---> 屯象OS API <---> 屯象OS数据库
    |                |
    |                |
Webhook推送      API同步
```
...
如有问题,请联系:
- 屯象OS技术支持: support@zhilian-os.com
- 易订技术支持: 参考易订官方文档
